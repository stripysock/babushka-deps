...
meta :rbenv do
  ...
  template {
    requires "stripysock:rbenv", "stripysock:ruby-build", "stripysock:ruby-build upgraded"
    ...
    meet {
      ...
      log_shell "Installing bundler", "RBENV_VERSION=#{version} gem install bundler --force"
    }
  }
end
